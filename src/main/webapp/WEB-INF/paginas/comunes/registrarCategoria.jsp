        ...
        <div class="modal fade" <%= modalStatic %> id="registrarCategoria">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <form action="${pageContext.request.contextPath}/Categoria" method="POST" enctype="multipart/form-data" name="Categorias">
                        <div class="modal-body">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control mt-1" onclick="verificar()" value="${categoria.descripcionCategoria}" name="descripcionCategoria" id="descripcionCategoria" required>
                            </div>
                            <div class="form-group mb-2">
